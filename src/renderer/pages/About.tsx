  ...
  return (
    ...
    >
      <div className="glass-card mx-auto max-w-lg p-8 text-center">
        ...
        <h2 className="mb-2 text-2xl font-bold text-white">老兵AI智剪</h2>
        <p className="mb-6 text-dark-400">v0.1.0</p>

        <p className="mb-8 text-sm leading-relaxed text-dark-400">
          一款 AI 驱动的智能视频剪辑桌面应用。
          <br />
